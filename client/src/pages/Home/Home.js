        ...
        <div className="row">
            ...
            <div className="jumbotron loginJumbo">
               ...
               <div className="pull-right col-md-8">
                ...
                <p className="lead" id="explanation-paragraph" style={{position: 'relative', zIndex: 20, paddingTop: '400px'}}>The University of Denver's Coding Bootcamp App powered by<br />Trilogy Educations Services Boot Camp curriculum offers current<br />and past students an archive of all classroom learning videos,<br />cut down from the original source to the bare essential information<br />for each learning topic and solved activity.</p>
               <br />
